...
namespace Borg.Framework.Storage
{
    ...
    {
        public FileSpecDefinition(TKey id, string fullPath, string name, DateTimeOffset creationDate, DateTimeOffset lastWrite,
            DateTimeOffset? lastRead, long sizeInBytes, string mimeType) : base(fullPath, name, creationDate, lastWrite,
    ...
    public class FileSpecDefinition : IFileSpec
    {
        ...
        public FileSpecDefinition(string fullPath, string name, DateTimeOffset creationDate, DateTimeOffset lastWrite, DateTimeOffset? lastRead,
        ...
        public DateTimeOffset LastWrite { get; protected set; }
        public DateTimeOffset? LastRead { get; protected set; }
